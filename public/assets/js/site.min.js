function initializeSiteConfig(){let n=document.getElementById("highlightImages"),i=document.getElementById("testimonialsList");var e=document.getElementById("addHighlightImage"),t=document.getElementById("saveSiteConfig"),a=document.querySelectorAll('input[name="showTestimonials"]');let o=document.getElementById("testimonialsSection"),l=document.querySelector('input[name="_csrf_token"]')?.value;l||console.error("Token CSRF não encontrado. Verifique o HTML."),fetch("/admin/site/getHighlights",{method:"GET",headers:{"X-CSRF-TOKEN":l,"X-Requested-With":"XMLHttpRequest"}}).then(e=>e.json()).then(e=>{e.success&&e.highlights&&(n.innerHTML="",e.highlights.forEach(e=>{var t=document.createElement("div");t.className="thumbnail-container col-md-3",t.dataset.id=e.id,t.innerHTML=`
